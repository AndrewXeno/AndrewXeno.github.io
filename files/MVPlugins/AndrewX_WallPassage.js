...
//=============================================================================
/*:
 * @plugindesc v0.80 Enable characters to walk behind walls. 
 ...
 * @desc Tiles with listed Region ID will be shown above characters (passage unchanged). Separate with commas.
 * Use 0 if you do not wish to make use of this property.
 * @default 0
 *
 * @param Passable Tile Region ID List
 * @desc Tiles with listed Region ID will be always passable. Separate multiple ID with commas.
 * Use 0 if you do not wish to make use of this property.
 * @default 0
 * 
 * @param Impassable Tile Region ID List
 * @desc Tiles with listed Region ID will not be passable. Separate multiple ID with commas.
 * Use 0 if you do not wish to make use of this property.
 * @default 0
 * 
 * @help
